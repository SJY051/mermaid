...
- Evidence-collection digest: SHA-256 `02e1481352ee74f2b7284a22d0fa4b5e5ee6a6dba0461c81ff58352d56317d74`, computed over `SHA-256␠␠scan-relative-path\n` for the ordered 13-file inventory below.
...
| `EV-A` | Track A final chat-failure audit | `artifacts/finalization/track_a_final_audit.md` | `6042d9dd489118caae727afc6de7916658ff6d4798386acca9c18cf4b791e057` | Coercion failure, stale-runtime stacks, missing value-free correlation |
...
| `EV-DIAG` | Integrated diagnostic/security prefinal | `artifacts/finalization/diagnostic_security_review_round06_prefinal.md` | `3cea2871af41501355345f69b782e9a082107dd3f0f366c7543abac55d8c2790` | Cross-track root-cause ordering; only where final audits do not supersede it |
...
| `EV-GATE` | Superseded central check-only verification | `artifacts/central_validation_round06/FINAL_CHECK_ONLY_VERIFICATION.md` | `4d26e0e4cc6a973ea5426b34a712096cae53bd6688729d4cc00e6ec3fdb75c9d` | Establishes that old totals/seals are invalid and fresh adoption is blocked by repo drift |
